...
1. 优先检索最近 30 天
2. 不足 5 篇、无法组成“4 篇临床研究＋1 篇基础研究”，或优先期刊不足 3 篇时扩展到最近 180 天；扩展后最近 30 天文献仍优先
...
6. 要求期刊影响因子严格大于 5；数值未知或期刊未配置时排除
7. 验证 DOI、识别 PMC 全文
8. 通过统一 `generateAI()` 接口调用当前模型完成提取、生成、复核
9. 更新网页数据、往期简报和RSS
10. 保存本次运行记录、Token汇总和正式推送历史
