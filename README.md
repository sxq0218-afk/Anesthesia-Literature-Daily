...
邮件订阅已支持腾讯云邮件推送 SES，默认关闭，不会影响网页、RSS和每日文献任务。首次启用请阅读 [腾讯云邮件订阅配置教程](./docs/腾讯云邮件订阅配置教程.md)。
...
当前不包含用户注册、登录、微信、小程序、支付、收藏、社区或个性化推荐。邮件订阅采用专用收件邮箱二次确认和腾讯云SES发送；订阅名单只以加密文件保存，不进入公开网页或日志。RSS仍可独立使用。
