...
export default function PrivacyPage() {
  return <><PageHero eyebrow="PRIVACY" title="隐私说明" description="更新日期：2026年7月16日。本说明适用于“每日麻醉文献精读”公开测试站。" /><section className="content-section"><div className="shell narrow prose">
    <h2>不建立用户账户</h2><p>公开测试站不提供注册、登录、邮件订阅、收藏或评论，不收集邮箱、姓名、病历或患者信息。第一阶段订阅界面仅保留在本地开发模式，不属于公开服务。</p>
    ...
    <h2>密钥与后台任务</h2><p>公开Production模式的AI API Key只保存在GitHub Actions Secrets。密钥不会进入HTML、前端JavaScript、公开JSON或构建日志。普通访客不能通过浏览器调用AI接口或修改AI配置。</p>
