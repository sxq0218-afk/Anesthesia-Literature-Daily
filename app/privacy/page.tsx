...
export default function PrivacyPage() {
  return <><PageHero eyebrow="PRIVACY" title="隐私说明" description="更新日期：2026年7月16日。本说明适用于“每日麻醉文献精读”公开测试站。" /><section className="content-section"><div className="shell narrow prose">
    ...
    <h2>邮件订阅数据</h2><p>当前邮件服务使用Buttondown。订阅采用二次确认：首次提交邮箱后，必须点击确认邮件才会启用。邮箱地址、确认状态、退订状态及必要投递记录由Buttondown处理；本站不把订阅名单写入公开网页、公开JSON或任务日志。Buttondown的API Key只保存在GitHub Actions Secrets。若未来切换腾讯云SES，本地加密订阅名单方案仍可作为备用。</p>
