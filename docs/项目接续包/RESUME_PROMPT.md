...
- 优先检索最近30天，条件不足时扩展到最近180天；180天仍不足时扩展到最近360天。
- 每日最多5篇，目标为4篇临床证据和1篇麻醉相关基础研究；系统评价、Meta分析、指南和共识计入临床证据。
- 合格临床证据和基础研究分别按影响因子降序选择；影响因子相同时再比较综合质量、证据质量和发表日期。
- 期刊影响因子必须严格大于5；未知、未配置或指标年份过旧的期刊排除。
- 评分至少45且专业相关性大于0。
- PMID、DOI和标题相似度去重。
- 已正式发布或发送的文献永久排除。
- candidate、Demo、failed或未正式发布记录不进入永久排除历史。
- 最近360天仍不足5篇时允许少发，不能降低质量凑数。
- 不允许临床证据与基础研究跨类别补位。
- AI必须完成结构化提取、完整摘要中文翻译、精读V2和统一事实检查。
- 精读V2包含方法学拆解、统计方法、结果精析、批判性评价、临床转化和证据缺口。
- 邮件展示最终完整内容，不重复展示新旧栏目，不提供项目自身网页链接；保留PubMed、DOI、出版商和PMC来源链接。
